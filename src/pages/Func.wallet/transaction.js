...
let INFRA_PROJECT_ID = 'ce14bd601a7e415dab1cd1af1410bcc9'
...
async function signAndSendTx(from, to, data, value) {
	try {
...
async function transferErc20Token(
	...
	return await signAndSendTx(fromAddress, tokenAddress, data, null)
}
...
async function sendETH(fromAddress, toAddress, amount) {
	...
	return await signAndSendTx(fromAddress, toAddress, null, eth_amount)
}
